...
//            }
    ...
    PLOT_LINES.forEach(pl=>{
//        if (Math.random()<.1){   // only plot some of the lines for a more random variation
        ctx.beginPath();
        ctx.moveTo(pl[0][0]*SCALE, pl[0][1]*SCALE);
        ctx.lineTo(pl[1][0]*SCALE, pl[1][1]*SCALE);
        ctx.stroke();
//        }
    })
}
