...
A=requestAnimationFrame;P=0;s=Math.sin;X=C.getContext('2d');R=(a=999)=>$fx.rand()*a;
D=2000;
...
Q=c=>X.fillStyle='#'+c;x=y=i=V=0;M=80;MO=3+R(50)|0;B='ffe';N='000';W='fff';d0=[W,N,'Black on White'];d1=[B,'e33','Default'];Z=[d0,d0,[N,W,'White on Black'],d1,d1,[B,'2d2','Green on Beige'],[B,'12d','Blue on Beige'],[N,'2d2','Green on Black']][R(7.5)|0];Q(Z[0]);X.fillRect(0,0,D,D);Q(Z[1]);X.globalAlpha =Z[0]===N?.08:.1;O=Z[0]===W?1.5:1;
...
G=0;q=_=>{R()<600?(MY=16,MX=15,DY=31,DX=22,X1=38,X2=27):(DY=9+R(24),DX=9+R(24),X1=10+R(99),X2=5+R(80),MY=5+R(30),MX=5+R(35));L=[[R(),R()],[R(),R()]];b();G++;(sX>1.5&&sY>1.5&&sX<8&&sY<8)?A(T):G>20?A(T):q()};document.addEventListener('keydown',function(e){if (e.code === 'Space'){e.preventDefault();P=!P;!P&&A(T)}});q();
